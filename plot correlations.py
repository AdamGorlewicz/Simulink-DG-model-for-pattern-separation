...
x = [0.2, 0.4, 0.6, 0.8, 1]
naive_control_data_count = len(naive_control_data)
naive_control_data_mean = naive_control_data.mean(axis = 0, numeric_only = True)
naive_control_data_std = naive_control_data.std()
...
ax.plot(x, naive_control_data.T, 'o', color='grey', markersize=5, zorder = 0, clip_on = False)
ax.axline((0, 0), ls ='--', color = 'red', slope=1)
...
ax.set_ylabel('output correlation', fontsize=24)
